...
Anyone is welcome to contribute to LNPOS. If you're looking for somewhere to start contributing, check out the [good first issue](https://github.com/impa10r/lnpos/issues?q=is%3Aopen+is%3Aissue+label%3A"good+first+issue") list.

## Communication Channels

Most communication about LNPOS happens on the main [Telegram group](https://t.me/lnpos). Discussion about code changes happens in GitHub issues and pull requests.

## Contributor Workflow

All LNPOS contributors submit changes via pull requests. The workflow is as follows:
...
LNPOS follows the review workflow established by the Bitcoin Core project. The following is adapted from the [Bitcoin Core contributor documentation](https://github.com/bitcoin/bitcoin/blob/master/CONTRIBUTING.md#peer-review):
...
We use [Airbnb javascript style guide](https://github.com/airbnb/javascript) in order to have a cleaner code. Here is a guide how to install [ESLint for VS Code](https://medium.com/@samailabalap/setting-up-eslint-on-vs-code-with-airbnb-javascript-style-guide-4d9936897f03).
